...
with open('createData.cfg', "r") as f:
    ...
    #print(line) 
        ...
        if title == 'Amount':
            ...
            temp = Paths_To_3D_Models[0]
            Paths_To_3D_Models[0] = Paths_To_3D_Models[2]       # HARDCODED!!!! NOT GOOOD! s
            Paths_To_3D_Models[2] = temp
            temp = Paths_To_3D_Models[1]
            Paths_To_3D_Models[1] = Paths_To_3D_Models[0]
            Paths_To_3D_Models[0] = temp
            #print(Paths_To_3D_Models)
...
for i in range(len(Name_of_Obj)):
    ...
    """
    print(Name_of_Obj[i])
    print(Path_To_Images_rendered)
    print(Paths_To_3D_Models[i])
    print(Name_of_Obj[i]+"_"+str(i)+"_"+str(progress))
    """
for i in range(len(Name_of_Obj)):    
...
print(Paths_To_Rendered_Images)
